...
Answers with `triggersCriticalFlag: true` surface a **Critical Exposure Warning** on the assessment report regardless of overall score. See [DOC-111A – Scoring Engine Specification](DOC-111A%20-%20Scoring%20Engine%20Specification.md).
