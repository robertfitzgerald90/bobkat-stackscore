...
This document is the **final, authoritative** scoring specification for BobKat StackScore v1. It supersedes conflicting sections in [ScoreCalculation.md](ScoreCalculation.md) where noted.

**Related documents:** [QuestionScoringMatrix.md](QuestionScoringMatrix.md), [DatabaseSchema.md](DatabaseSchema.md), [RecommendationRuleCatalog.json](RecommendationRuleCatalog.json)
...
Each question has a **weight** (maximum points) defined in [QuestionScoringMatrix.md](QuestionScoringMatrix.md).
...
The **Risk Multiplier Logic** described in [ScoreCalculation.md](ScoreCalculation.md) is **deprecated**. StackScore v1 uses **critical flags only**:

- Worst-tier answers do **not** apply additional score penalties beyond `scoreValue = 0`.
- Specific answers set `triggersCriticalFlag = true` (see [QuestionScoringMatrix.md](QuestionScoringMatrix.md)).
...
- [ ] Seed questions and answer options from [QuestionScoringMatrix.md](QuestionScoringMatrix.md)
...
## Deprecation Notice for ScoreCalculation.md

The following sections of [ScoreCalculation.md](ScoreCalculation.md) are superseded by this document:
...
All other sections of ScoreCalculation.md remain valid reference material for business context and examples.
