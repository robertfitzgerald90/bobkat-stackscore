...
**Related documents:** [MVP_PRD.md](MVP_PRD.md), [DatabaseSchema.md](DatabaseSchema.md), [RBAC_Security_Spec.md](RBAC_Security_Spec.md), [API_Specification.md](API_Specification.md)
...
**Rules source:** [ScoringSpecification.md](ScoringSpecification.md), [QuestionScoringMatrix.md](QuestionScoringMatrix.md)
...
[DatabaseSchema.md](DatabaseSchema.md) is implemented in `prisma/schema.prisma`.
...
Loaded from:
- Categories: fixed 7 categories from DatabaseSchema
- Questions + Answer Options: [QuestionScoringMatrix.md](QuestionScoringMatrix.md)
...
REST-style JSON API via Next.js Route Handlers. Full endpoint list in [API_Specification.md](API_Specification.md).
...
- [ ] Implement schema from DatabaseSchema.md
- [ ] Seed script from QuestionScoringMatrix + RecommendationRuleCatalog
- [ ] Session auth per RBAC_Security_Spec
- [ ] Scoring service with unit tests matching ScoringSpecification examples
- [ ] Recommendation service with consolidation tests
- [ ] API routes per API_Specification
