...
const STATIC_ROUTE_TITLES: Array<{ pattern: RegExp; title: string }> = [
  ...
  { pattern: /^\/technology-catalog\/[^/]+$/, title: "Technology Catalog" },
  { pattern: /^\/email\/preview\/account-activation$/, title: "Email Preview" },
  ...
  { pattern: /^\/admin\/communications\/campaigns$/, title: "Campaigns" },
  { pattern: /^\/admin\/communications\/prospects\/import$/, title: "Import Prospects" },
  { pattern: /^\/admin\/communications\/prospects\/[^/]+$/, title: "Prospect Detail" },
  { pattern: /^\/admin\/communications\/prospects$/, title: "Prospects" },
...
const CLIENT_SUBROUTE_TITLES: Array<{ pattern: RegExp; title: string }> = [
  ...
  { pattern: /^\/clients\/[^/]+\/technology-profile$/, title: "Executive Briefing" },
