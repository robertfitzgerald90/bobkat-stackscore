...
export const EMAIL_TEMPLATE_REGISTRY: EmailTemplateDefinition[] = [
  ...
  workflowTemplate({
    ...
    name: "Strategic IT Consulting Welcome",
    description:
      "Client lifecycle email sent when a Strategic IT Consulting subscription becomes active.",
    category: "lifecycle",
    status: "active",
  ...
  workflowTemplate({
    ...
    name: "Strategic IT Consulting Payment Failed",
    description:
      "Notifies a customer that a Strategic IT Consulting subscription payment failed.",
    category: "billing",
    status: "active",
    subject: VCIO_CUSTOMER_EMAIL_COPY.paymentFailed.subject,
    ...
    sampleData: {
      heroTitle: VCIO_CUSTOMER_EMAIL_COPY.paymentFailed.heroTitle,
      previewText: VCIO_CUSTOMER_EMAIL_COPY.paymentFailed.previewText,
  ...
  workflowTemplate({
    ...
    name: "Strategic IT Consulting Cancellation Scheduled",
    description: "Confirms that a Strategic IT Consulting subscription is scheduled to cancel.",
    category: "billing",
    status: "active",
    subject: VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.subject,
    previewText: VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.previewText,
    lastUpdated: LAST_UPDATED,
    requiredVariables: ["primaryCta"],
    ...
    sampleData: {
      heroTitle: VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.heroTitle,
      previewText: VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.previewText,
      paragraphs: [...VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.paragraphs],
      primaryCta: {
        label: VCIO_CUSTOMER_EMAIL_COPY.cancellationScheduled.primaryCta,
        href: PREVIEW_PROTECTED_URL,
      },
    },
  }),
  workflowTemplate({
    ...
    name: "Strategic IT Consulting Ended",
    description: "Notifies a customer that their Strategic IT Consulting subscription has ended.",
    category: "billing",
    status: "active",
    subject: VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.subject,
    previewText: VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.previewText,
    lastUpdated: LAST_UPDATED,
    requiredVariables: ["primaryCta"],
    optionalVariables: ["firstName", "organizationName"],
    defaults: {
    ...
    sampleData: {
      heroTitle: VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.heroTitle,
      previewText: VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.previewText,
      paragraphs: [...VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.paragraphs],
      primaryCta: {
        label: VCIO_CUSTOMER_EMAIL_COPY.subscriptionEnded.primaryCta,
        href: PREVIEW_PROTECTED_URL,
      },
    },
  }),
