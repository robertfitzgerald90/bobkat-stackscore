...
export const DEMO_REPORT_PREVIEWS: Record<string, DemoReportPreview> = {
    ...
    sections: [
      {
        ...
        body: "This plan prioritizes identity protection and business continuity before network modernization, aligning a practical $48,000 annual technology budget with Northstar's highest business risks.",
      },
      {
        heading: "Critical Priorities",
        bullets: [
          "Harden MFA on Microsoft 365 Business Premium — Critical · $2,000–$4,000 · Q3 2026",
          "Implement Centralized Backup Validation — High · $3,500–$6,500 · Q4 2026",
          "Modernize Ubiquiti Switching & Wi-Fi — High · $6,000–$10,000 · Q4 2026",
        ],
      },
    ],
  },
  "report-qbr": {
    ...
    metrics: [
      ...
      { label: "Budget Utilization", value: "63%" },
    ],
    sections: [
      {
        heading: "Executive Summary",
        body: "Technology score improved 6 points since the last quarterly review. Two strategic projects completed on schedule with measurable risk reduction. Spending remains disciplined against a $48,000 annual plan.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Execute first backup validation recovery test",
          "Finalize Ubiquiti network refresh schedule",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "The approved roadmap sequences identity protection and backup validation before Ubiquiti network modernization — spend smarter, not more, with manageable quarterly investments.",
      },
      {
        heading: "Quarter Highlights",
        bullets: [
          "Q3 2026: Microsoft 365 hardening, backup validation, endpoint lifecycle",
          "Q4 2026: Ubiquiti network refresh, disaster recovery exercise, vendor cleanup",
  ...
  "report-budget": {
    ...
    generatedDate: "July 15, 2026",
    metrics: [
      { label: "Annual Plan", value: "$48,000" },
      { label: "Approved", value: "$30,000" },
      { label: "Committed", value: "$18,000" },
      { label: "Remaining", value: "$12,000" },
    ],
    sections: [
      {
        heading: "Investment Summary",
        body: "Technology spending is aligned with the approved roadmap, with 63% of the annual plan approved and remaining capacity reserved for Q4 priorities. The goal is informed investment — not larger budgets.",
      },
      {
        ...
        bullets: [
          ...
          "Cloud & Microsoft 365: $8,000",
          "Projects & Implementation: $7,000",
          "Professional Services: $5,000",
          "Business Continuity: $4,000",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Northstar Manufacturing has moved from reactive technology management to a measurable improvement program with executive accountability, prioritized SMB-scale investments, and clear progress tracking.",
      },
      {
        heading: "Strategic Direction",
        bullets: [
          "Close identity protection gaps before network modernization",
          "Validate backup and disaster recovery readiness",
          "Modernize Ubiquiti networking at a practical investment level",
