...
export const SERVICES_CATALOG: ServiceCatalogItem[] = [
  ...
  },
  {
    ...
    description:
      "Your digital presence should do more than simply exist—it should build trust, strengthen your brand, and create better experiences for your customers. Bobkat IT designs modern websites, secure client portals, and executive dashboards that help businesses communicate more effectively and operate with greater visibility.",
    highlights: [
      ...
      "Digital Strategy & Technology Guidance",
    ],
