    ...
    <div className="flex h-screen min-h-screen overflow-hidden bg-background">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main
          className={
            user.role === "client"
              ? "page-content min-w-0 flex-1 overflow-y-auto overflow-x-clip bg-muted/10 p-4 sm:p-6 lg:p-8"
              : "page-content min-w-0 flex-1 overflow-y-auto overflow-x-clip bg-muted/30 p-4 dark:bg-surface-elevated/20 sm:p-6 lg:p-8"
          }
        >
          {children}
        </main>
